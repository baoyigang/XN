...
namespace App.View.Task
{
    public partial class frmInStock : BaseForm
    {
        ...
        {
            DataTable dt = bll.FillDataTable("WCS.SelectTask", new DataParameter[] { new DataParameter("{0}", string.Format("WCS_TASK.WarehouseCode = '{0}' and WCS_TASK.State in('0','1','2','3','7') and WCS_TASK.TaskType='11' and {1}", Program.WarehouseCode, filter)) });
            bsMain.DataSource = dt;
        }
